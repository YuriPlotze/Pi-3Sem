// Função para obter o estoque do localStorage
...
function addProduct(event) {
  ...
  var isCodeExists = inventory.some(function(product) {
    return product.code === codeInput.value;
  });

  if (isCodeExists) {
    alert('Código de produto já cadastrado!');
    return;
  }
...
// Renderiza o estoque inicial ao carregar a página
renderInventory();
